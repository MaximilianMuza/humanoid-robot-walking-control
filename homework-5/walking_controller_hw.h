...
public:
  ...
  double quintic_polynomial(double t, const Eigen::VectorXd& coeffs);
  Eigen::VectorXd compute_quintic_coefficients(double x0, double xT, double T);
  ...
  void previewcontroller(double dt, int NL, int tick, double x_i, double y_i, Eigen::Vector3d xs, Eigen::Vector3d ys, double& UX, double& UY, 
       Eigen::MatrixXd Gi, Eigen::VectorXd Gd, Eigen::MatrixXd Gx, Eigen::MatrixXd A, Eigen::VectorXd B, Eigen::MatrixXd C, Eigen::MatrixXd D, Eigen::Vector3d &XD, Eigen::Vector3d &YD);
  void preview_Parameter(double dt, int NL, Eigen::MatrixXd& Gi, Eigen::VectorXd& Gd, Eigen::MatrixXd& Gx, Eigen::MatrixXd& A, Eigen::VectorXd& B, Eigen::MatrixXd& C, Eigen::MatrixXd& D);
...
private:
 ...
 //
  ...
  //Compliant Control
  Eigen::Vector12d prev_motor_q_leg_;
